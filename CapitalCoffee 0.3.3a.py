        ...
        if (self.order_type.get() == "delivery" or
            ...
            if self.customer_name.get() != "":
                ...
                if ((self.customer_address.get() != "" and
                    ...
                    if ((self.customer_number.get().
                         replace(" ", "").
                         isnumeric()) or self.order_type.get() == "pickup"):

                        # Checks to make sure at least one coffee is selected
                        if self.COFFEES[0] != self.coffee_one.get():

                            receipt_name = "{} Receipt.txt".format(
                                self.customer_name.get())

                            # Opens a file for printing receipt to
                            ...
                            if self.order_type.get() == "delivery":
                                ...
                                receipt.write("Phone Number: {}\n".format(
                                    self.customer_number.get()))
                            ...
                            if self.order_type.get() == "delivery":
                                ...
                                receipt.write("Delivery Charge: $3.00\n")
                            ...
                            receipt.write(
                                "Total Price: ${}".format(self.string_cost))
